...
process CHECK_CONTAMINATION {
    ...
    path "contamination_value.txt", emit: contamination
    ...
    with open("contamination_value.txt", "w") as f:
        f.write(str(float(row["FREEMIX"])/${contamination_underestimation_factor}))
    CODE
    """
}
